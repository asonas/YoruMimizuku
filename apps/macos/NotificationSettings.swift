...
/// settings screen and the window's polling/badge wiring read the same values.
///
/// OS notification banners and the Dock badge are out of scope here (planned for
