...
- [x] **Step 3: macOS のコンポーザ生成を `PostDisplay?` に変更する**
...
- [x] **Step 4: `ComposerView` に返信先プレビューを追加する**
...
- [x] **Step 1: URI だけで会話タブを開く Workspace API のテストを書く**
...
- [x] **Step 2: `WorkspaceModel` に軽量会話タブ API を追加する**
...
- [x] **Step 3: 通知ビューに `onOpenSubject` を渡す**
